...
static const struct imx415_mode supported_modes[] = {
	 ...
	 */
	{
		...
		.vts_def = 0x08ca,
		.global_reg_list = NULL, // todo
		.global_reg_list = NULL, // todo
		.reg_list = imx415_linear_10bit_3864x2192_1782M_regs, // todo
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 3,
		.bpp = 10,
		.vc[PAD0] = 0,
	...
	},
	{
		...
		.vts_def = 0x08ca,
		.global_reg_list = imx415_global_10bit_3864x2192_regs,  // todo
		.reg_list = imx415_linear_10bit_1920x1080_891M_regs,  // todo
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 1,
		.bpp = 10,
		.vc[PAD0] = 0,
